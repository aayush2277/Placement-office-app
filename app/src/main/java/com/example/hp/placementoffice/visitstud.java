...
public class visitstud extends AppCompatActivity {
    String msg="";
    EditText e1,e2;
    String user,p;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visitstud);
    ...
    class myasync extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... strings) {
            ...
            String serverURL="https://aayushgupta226670.000webhostapp.com/loginstud.php";
            InputStream is=null;
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Intent i=new Intent(visitstud.this,updstud.class);
                startActivity(i);
            }
            else {
                Toast.makeText(visitstud.this,"Invalid Username or Password",Toast.LENGTH_LONG).show();
            }
