...
public class visitcomp extends AppCompatActivity {
    String msg = "";
    EditText e1, e2;
    String user, p;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visitcomp);
    ...
    class myasync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String serverURL = "https://aayushgupta226670.000webhostapp.com/logincomp.php";
            InputStream is = null;
        ...
        protected void onPostExecute(String s) {
            ...
            if (a.equalsIgnoreCase("success")) {
                Intent i = new Intent(visitcomp.this, updcompany.class);
                startActivity(i);
            } else {
                Toast.makeText(visitcomp.this, "Invalid Username or Password", Toast.LENGTH_LONG).show();
            }
