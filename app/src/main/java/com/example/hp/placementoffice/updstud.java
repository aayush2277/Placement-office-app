...
public class updstud extends AppCompatActivity {
...
int r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updstud);
   ...
   class myasync extends AsyncTask<Void,Void,Void>
   {
       ...
       protected Void doInBackground(Void... voids) {
           senddata(updstud.this,r,n,f,e,c,a,t,tw,g,tec,pass);
           return null;
       }

   }
    static void senddata(Context co,int r,String n,String f,String e,String c,String a,Double t,Double tw,Double g,String tec,String pass)
    {
        String url="https://aayushgupta226670.000webhostapp.com/updatestudents.php";
